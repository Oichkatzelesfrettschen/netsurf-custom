...
CORESTRING_LWC_VALUE(must_revalidate, "must-revalidate");
CORESTRING_LWC_VALUE(cc_private, "private");
CORESTRING_LWC_VALUE(s_maxage, "s-maxage");
...
CORESTRING_DOM_STRING(contenteditable);
...
CORESTRING_DOM_STRING(download);
CORESTRING_DOM_STRING(draggable);
...
CORESTRING_DOM_STRING(formaction);
CORESTRING_DOM_STRING(formenctype);
CORESTRING_DOM_STRING(formmethod);
CORESTRING_DOM_STRING(formnovalidate);
CORESTRING_DOM_STRING(formtarget);
...
CORESTRING_DOM_STRING(maxlength);
CORESTRING_DOM_STRING(minlength);
CORESTRING_DOM_STRING(max);
CORESTRING_DOM_STRING(min);
...
CORESTRING_DOM_STRING(multiple);
CORESTRING_DOM_STRING(name);
CORESTRING_DOM_STRING(nonce);
CORESTRING_DOM_STRING(novalidate);
...
CORESTRING_DOM_STRING(pattern);
CORESTRING_DOM_STRING(ping);
CORESTRING_DOM_STRING(placeholder);
...
CORESTRING_DOM_STRING(referrerpolicy);
CORESTRING_DOM_STRING(rel);
CORESTRING_DOM_STRING(required);
...
CORESTRING_DOM_STRING(slot);
CORESTRING_DOM_STRING(spellcheck);
CORESTRING_DOM_STRING(src);
CORESTRING_DOM_STRING(step);
...
CORESTRING_DOM_STRING(autofocus);
...
CORESTRING_DOM_STRING(translate);
